...
function screenNavigateNext(withChapter) {
  ...
  timeline.add({
    ...
    begin: function begin(anim) {
      ...
      $screenToShow.classList.add('is-active', 'is-showing--next'); // console.log('begin anim 2')
    },
    complete: function complete(anim) {
      ...
      screenScrollHandler();
      isNavTransition = false; // console.log('complete anim 2')
    }
  }, '-=400');
}
...
},{"../scss/main.scss":"fx60","animejs/lib/anime.es.js":"ndqK","debounce":"dLxY"}]},{},["QvaY"], null)